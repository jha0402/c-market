...
const Test: NextPage = () => {
    ...
    const onValid = (data: LoginForm) => {
        ...
        // setError('errors', { message: 'Username already taken' });
        reset();
    };
    ...
    return (
        <>
            ...
            {/* JIT: Just in time compiler // Before there was a purging process that cleans up the unnecessary css for
            production and modifiers could not be used together // JIT : watching the code and creating the classes on
            demand // Custom css outside the tailwind classes: text-[999px], text-[#222222], bg-[url('/vercel.svg')] */}
