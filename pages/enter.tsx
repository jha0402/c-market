                    ...
                    <div className='mt-1'>
                        ...
                        {method === 'phone' ? (
                            <div className='flex rounded-md shadow-sm'>
                                <span className='flex items-center justify-center px-3 rounded-l-md border border-r-0 shadow-sm border-gray-300 bg-gray-50 text-gray-500 select-none text-sm'>
                                    +82
                                </span>
                                <input
                                    id='input'
