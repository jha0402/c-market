        ...
        <div className='py-10 px-4'>
            ...
            <div className='mt-12'>
                <div className='flex items-center space-x-4'>
                    ...
                    <div>
                        <h4 className='text-sm font-bold text-gray-900'>정현</h4>
                ...
                <div className='mt-4 text-gray-600 text-sm'>
                    <p>
                        ...
                        shit while I&apos;m in a transitional period so I don&apos;t wanna kill you, I wanna help you.
                        But I can&apos;t give you this case, it don&apos;t belong to me. Besides, I&apos;ve already been
                        through too much shit this morning over this case to hand it over to your dumb ass.
                    </p>
                </div>
            </div>
        </div>
